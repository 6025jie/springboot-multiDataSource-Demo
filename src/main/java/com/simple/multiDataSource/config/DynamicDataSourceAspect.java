...
public class DynamicDataSourceAspect {
	...
	@Pointcut(value = "execution(* com.simple.multiDataSource.mapper.*.*(..))")
	...
	public Object around(ProceedingJoinPoint point) throws Throwable {
		...
		try {
			...
			logger.info("{} | method  {}  | datasource  {}  | begin",
					((MethodSignature) point.getSignature()).getMethod().getDeclaringClass(), methodName, dataSource);
		}
	...
	//
	// logger.info("{} | method {} | datasource {} | end",
	// ((MethodSignature) point.getSignature()).getMethod().getDeclaringClass(),
	// methodName,
